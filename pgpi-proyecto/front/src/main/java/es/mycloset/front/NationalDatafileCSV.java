...
public class NationalDatafileCSV {

    public NationalDatafileCSV(String id, String mscode, String year, String estcode, Float estimate, Float se, Float lowercib, Float uppercib, String flag) {
        this.id = id;
        this.mscode = mscode;
        this.year = year;
